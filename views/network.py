...
class NetworkView(QWidget, ScaleMixin):
    ...
    def _build_traffic_card(self, parent):
        card = Card(title="Network Traffic", icon="📈")
    ...
    def _build_middle_row(self, parent):
        ...
        proto_card = Card(title="Protocol Distribution", icon="🥧")
        ...
        # Interface status
        iface_card = Card(title="Network Interfaces", icon="🌐")
    ...
    def _build_radar_row(self, parent):
        ...
        # Radar / topology
        radar_card = Card(title="Network Topology", icon="📡")
