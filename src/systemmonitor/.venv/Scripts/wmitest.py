...
import os, sys
import systemmonitor.datetime
try:
    import ConfigParser
except ImportError:
    import configparser as ConfigParser
import systemmonitor.operator
try:
    import Queue
except ImportError:
...
import systemmonitor.subprocess
import systemmonitor.tempfile
import systemmonitor.threading
import systemmonitor.time
import systemmonitor.unittest
import systemmonitor.warnings
try:
    import _winreg
except ImportError:
    import winreg as _winreg

import systemmonitor.pythoncom
import systemmonitor.win32api
import systemmonitor.win32con
import systemmonitor.win32file

import systemmonitor.wmi
