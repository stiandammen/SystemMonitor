from systemmonitor.abc import ABCMeta, abstractmethod
from systemmonitor.dataclasses import dataclass, field
from systemmonitor.os import PathLike
from systemmonitor.typing import Any, Callable, Dict, Optional, Union
