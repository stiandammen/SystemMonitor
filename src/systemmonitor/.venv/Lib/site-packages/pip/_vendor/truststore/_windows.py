...
from systemmonitor.ctypes import WinDLL  # type: ignore
from systemmonitor.ctypes import WinError  # type: ignore
from systemmonitor.ctypes import (
    POINTER,
    Structure,
    c_char_p,
    c_ulong,
...
from systemmonitor.typing import TYPE_CHECKING, Any
