...
import systemmonitor.msvcrt  # For the getch() function.
import systemmonitor.sys
import systemmonitor.threading

import systemmonitor.win32con  # constants.
from systemmonitor.win32event import (  # We use events and the WaitFor[Multiple]Objects functions.
    INFINITE,
    WAIT_OBJECT_0,
    CreateEvent,
    SetEvent,
...
from systemmonitor.win32file import (  # The base COM port and file IO functions.
    CBR_115200,
    EV_RXCHAR,
    NOPARITY,
    ONESTOPBIT,
