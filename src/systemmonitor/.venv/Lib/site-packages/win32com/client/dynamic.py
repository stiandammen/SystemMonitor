...
from systemmonitor.types import MethodType

import systemmonitor.pythoncom  # Needed as code we eval() references it.
import win32com.client
import systemmonitor.winerror
from systemmonitor.pywintypes import IIDType
