...
from systemmonitor.typing import Optional, List, Dict, Any
...
# ---------------------------------------------------------------------------
# SectionCard â€“ kortbeholder med tittel og rader
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# GPUSingleView â€“ komplett visning for én GPU
# ---------------------------------------------------------------------------
class GPUSingleView(QWidget, ScaleMixin):
    ...
    def _build(self):
        ...
        # Klokker
        self._s_clk = SectionCard("KLOKKEFREKVENSER", "ph.clock")
        ...
        # Temperatur
        self._s_temp = SectionCard("TEMPERATUR", "ph.thermometer")
        ...
        # VRAM
        self._s_vram = SectionCard("VIDEOMINNE", "ph.database")
        ...
        # System
        self._s_sys = SectionCard("SYSTEMINFORMASJON", "ph.info")
...
# ---------------------------------------------------------------------------
# GPUInfoView â€“ driverinfo-visning for integrerte/sekundære GPUer
# ---------------------------------------------------------------------------
class GPUInfoView(QWidget):
    ...
    def _build(self):
        ...
        self._s_drv = SectionCard("DRIVER & SYSTEMINFORMASJON", "ph.gear")
